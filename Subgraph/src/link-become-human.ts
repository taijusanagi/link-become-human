import {
  ...
  HumanityScoreUpdated as HumanityScoreUpdatedEvent,
...
export function handleHumanityScoreUpdated(
  event: HumanityScoreUpdatedEvent
): void {
  let entity = new HumanityScoreUpdated(
    event.transaction.hash.concatI32(event.logIndex.toI32())
  )
  entity.tokenId = event.params.tokenId
  entity.humanityScore = event.params.humanityScore
...
export function handleRequestFulfilled(event: RequestFulfilledEvent): void {
  ...
  entity.LinkBecomeHuman_id = event.params.id
